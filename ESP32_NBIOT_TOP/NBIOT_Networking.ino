...
// tach rieng truyen o chan Tx voi Rx ra 2 ham rieng
// Ham gui du lieu
// moi lan gui du lieu (Tx) xong can doi du lieu nhan ve (Rx) --> tao 1 bit lam flag

// Ham nhan du lieu
// su dung ham uart_interrupt() --> loc du lieu --> 
